...
const Contact = () => {
  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-centerp-4'>
        <form id='myForm' method='POST' action="https://getform.io/f/c244c5d8-f16a-4be3-9c81-cb16e3e5d96c" className='flex flex-col max-w-[600px] w-full'>
           <div className='pb-8'>
           ...
           <input className='my-4 p-2 bg-[#ccd6f6]' type="email" placeholder='Email*' name='email' required />
            ...
            <button type='button' onclick={validateForm} className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 rounded-xl py-3 my-8 mx-auto flex items-center'>Submit</button>
        </form>
